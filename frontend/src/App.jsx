  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/signup" element={userId ? <Navigate to="/" /> : <Signup setUserId={handleSetUserId} />} />
        <Route path="/verify" element={userId ? <Navigate to="/" /> : <Verify setUserId={handleSetUserId} />} />
